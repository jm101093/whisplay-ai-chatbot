...
# Improved proxy download function
# If download fails, try replacing https://ghfast.top with https://gh-proxy.com or other similar GitHub acceleration services
download_with_proxy() {
    local url="$1"
    local output_file="$2"
